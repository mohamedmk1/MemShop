...
describe('CategoryFormComponent', () => {
    ...
    describe('ngOnInit()', () => {
        ...
        it('should initialize category form when with null value ' +
        ...
        it('should initialize category form when with category value ' +
            ...
            state.category.selectedCategory = category1;
            store.setState(state);
    ...
    describe('onSubmit()', () => {
        ...
        it('should dispatch addCategory with category value when is new', () => {
            // Arrange
            const dispatchSpy = jest.spyOn(store, 'dispatch');
            const category = Category
                .newBuilder()
        ...
        it('should dispatch updateCategory with category value when is update', () => {
            // Arrange
            const dispatchSpy = jest.spyOn(store, 'dispatch');
            const category = Category
                .newBuilder()
